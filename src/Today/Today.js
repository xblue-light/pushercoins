...
class Today extends Component {
    ...
    sendPricePusher (data) {
     ...
     componentDidMount () {
        // We can check for internet connectivity by using navigator.onLine
        // The code above is only executed when the browser is offline
        if (!navigator.onLine) {
        ...
        // We bind to the 'prices' event and use the data in it 
        //(price information) to update the state values, thus, realtime changes 
